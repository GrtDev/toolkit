...
function LanguageManager()
{
    ...
    if(typeof LanguageManager.prototype._singletonInstance !== 'undefined') {
    ...
    LanguageManager.prototype.instance = this;
    ...
    _this.dump = function ()
    {
        for(var languageID in _languages){
            ...
            _this.logInfo('language dump, \'id: ' + languageID + '\'', 'texts: ', language.texts, 'groups: ', language.groups);
        }
    }
 ...
 * @returns {LanguageManager} The LanguageManager instance.
 */
LanguageManager.getInstance = function ()
{
    return LanguageManager.prototype._singletonInstance || new LanguageManager();
};
