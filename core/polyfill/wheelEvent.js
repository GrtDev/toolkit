 ...
 */
module.exports = function wheelEventPolyfill ( opt_global ) {
     ...
     */
    (!("onwheel" in document.createElement( "div" )) && "EventTarget" in window // IE does not have shared parent for Node and Window
    ) && (function () {
